<template>
  <div class="abnormal-popoper" style="padding: 13px 18px 21px 18px">
    <div class="query searchInputFormItem" style="margin-bottom: 20px">
      <el-input v-model="params.keywords" placeholder="输入运动名称搜索"></el-input>
    ...
    >
      ...
      <el-table-column prop="name" label="运动名称" show-overflow-tooltip width="120px">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    fetch() {
      ...
      this.$api.sportListInterface.getSportLibraryListPage(Object.assign({}, this.params))
        .then(({ data }) => {
          if (data.code === 200) {
