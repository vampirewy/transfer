<template>
  <div class="information-audit-form">
    ...
    <div class="el-row-container">
      ...
      <el-row :gutter="18">
        <el-col :span="6">
          <div class="grid-content flex">
            <div class="align-self-flex-start label">身份证照片：</div>
            <el-image
              style="width: 130px; height: 160px"
              :src="upload_url + detailData.frontIdImage"
              fit="contain"
            />
          </div>
        </el-col>
        <el-col :span="6">
          <div class="grid-content">
            <el-image
              style="width: 130px; height: 160px"
              :src="upload_url + detailData.backIdImage"
              fit="contain"
            />
          </div>
        </el-col>
      ...
      <el-row :gutter="18">
        <el-col :span="6">
          <div class="grid-content flex">
            <div class="align-self-flex-start label">职业证书：</div>
            <el-image
              style="width: 130px; height: 160px"
              :src="upload_url + detailData.practisingCertificateImage"
              fit="contain"
            />
          </div>
        </el-col>
...
export default {
  ...
  mounted() {
    this.queryQualificationDetailById(this.detailId);
  },
  methods: {
    onDialogConfirm() {
      this.auditSubmit('2');
    ...
    queryQualificationDetailById(id) {
      this.$api.informationAuditInterface
