<template>
  ...
  <div class="user-follow">
    <el-table :data="table.list" style="width: 100%" align="center" ref="table"
      ...
      <el-table-column label="项目名称" prop="projectName" min-width="80px" show-overflow-tooltip>
        <template slot-scope="scope">
          <span>{{ scope.row.projectName | getResult}}</span>
        </template>
      </el-table-column>
      <el-table-column label="结果" prop="doctor" show-overflow-tooltip>
        <template slot-scope="scope">
      ...
      <el-table-column label="结束时间" prop="overTime" min-width="90px" show-overflow-tooltip>
        <template slot-scope="scope">
          <span>{{ scope.row.overTime | getResult}}</span>
        </template>
      </el-table-column>
      <el-table-column prop="medicalType" label="跟踪结果" show-overflow-tooltip>
        <template slot-scope="scope">
          <span>已痊愈</span>
        </template>
      </el-table-column>
