<template>
  ...
  <div class="user-follow">
    ...
    <div class="divRightTitleDiv">
      ...
      <div style="float: right;;margin: 10px 5px 20px 0">
        <el-radio-group v-model="warnType">
          <el-radio :label="0">近两份报告对比</el-radio>
          <el-radio :label="1">近三份报告对比</el-radio>
        </el-radio-group>
      </div>
    </div>
    <el-table :data="table.list" style="width: 100%" align="center" ref="table"
      ...
      <el-table-column label="异常项" prop="projectName" min-width="80px" show-overflow-tooltip>
        <template slot-scope="scope">
          <span>{{ scope.row.projectName | getResult}}</span>
        </template>
      </el-table-column>
      <el-table-column label="2021-04-15" prop="doctor" show-overflow-tooltip>
        <template slot-scope="scope">
          <span>{{scope.row.result1}}</span>
        </template>
      </el-table-column>
      <el-table-column label="2021-04-16" prop="createdTime" min-width="90px" show-overflow-tooltip>
        <template slot-scope="scope">
          <span>{{ scope.row.result2 | getResult}}</span>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
