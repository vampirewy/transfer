<template>
  <div class="abnormal-popoper">
    <div class="query searchInputFormItem">
      <el-input v-model="params.gridName" placeholder="输入类别名称搜索"></el-input>
    ...
    >
      ...
      <el-table-column label="类别名称" prop="gridName"></el-table-column>
    </el-table>
    <el-pagination
      background
...
export default {
  ...
  methods: {
    ...
    fetch() {
      ...
      this.$api.userManagerInterface.getGridList(Object.assign({}, this.params))
        .then(({ data }) => {
          if (data.code === 200) {
