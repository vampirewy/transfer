...
export default {
  ...
  methods: {
    ...
    reset() {
      ...
      this.forms.minSugar = '';
      this.forms.maxSugar = '';
      this.forms.sbpSelectType = '';
      this.forms.minSbp = '';
      this.forms.maxSbp = '';
      this.forms.dbpSelectType = '';
      this.forms.minDbp = '';
      this.forms.maxDbp = '';
      this.forms.wcSelectType = '';
      this.forms.minWc = '';
      this.forms.maxWc = '';
      this.forms.bdPercentSelectType = '';
      this.forms.minBdPercent = '';
      this.forms.maxBdPercent = '';
      this.forms.bmiSelectType = '';
      this.forms.minBmi = '';
      this.forms.maxBmi = '';
      this.forms.sportTimeSelectType = '';
      this.forms.minSportTime = '';
      this.forms.maxSportTime = '';
      this.forms.sportDistanceSelectType = '';
      this.forms.minSportDistance = '';
      this.forms.maxSportDistance = '';
      this.forms.sportKcalSelectType = '';
      this.forms.minSportKcal = '';
      this.forms.maxSportKcal = '';
      this.forms.sportStepsSelectType = '';
      this.forms.minSportSteps = '';
      this.forms.maxSportSteps = '';
      this.forms.resultSelectType = '';
      this.forms.minResult = '';
      this.forms.maxResult = '';
      this.forms.hbSelectType = ''; // 脉搏＞，＝，≥，≤
      this.forms.minHb = '';
      this.forms.maxHb = '';
      this.forms.healthDataItemName = '';
      this.table.pageNo = 1;
      this.queryPageList();
    },
    resetTable() {
