  ...
  >
    <div class="body">
          ...
          <el-form-item label="性别：">
            ...
            >
              <el-option
                ...
                :value="it.value"
                :key="i"
                v-for="(it, i) in form.genderList"
              ></el-option>
            </el-select>
          </el-form-item>

          <!--<el-form-item label="类别">
            <el-select v-model="form.gridName" placeholder="请选择类别" style="width: 120px">
      ...
      >
        ...
        <!--<el-table-column prop="gridName" label="客户类别"></el-table-column>-->
      </el-table>
