...
import Menubar from 'capsule-ui/src/utils/menu/aria-menubar';
import { addClass, removeClass, hasClass } from 'capsule-ui/src/utils/dom';
    ...
    const component = (
      <ul
        ...
        class={{
          ...
          'el-menu': true,
          'el-menu--activeborder': this.showActiveBorder,
          'el-menu--activebg': this.showActiveBackground,
          'el-menu--hoverbg': this.showHoverBackground
        }}
      >
        {this.$slots.default}
      </ul>
