...
<script>
import Popper from 'capsule-ui/src/utils/vue-popper';
import Clickoutside from 'capsule-ui/src/utils/clickoutside';
import Emitter from 'capsule-ui/src/mixins/emitter';
import Locale from 'capsule-ui/src/mixins/locale';
import Migrating from 'capsule-ui/src/mixins/migrating';
import ElInput from 'capsule-ui/packages/input';
import ElTag from 'capsule-ui/packages/tag';
import ElScrollbar from 'capsule-ui/packages/scrollbar';
import ElCascaderPanel from 'capsule-ui/packages/cascader-panel';
import AriaUtils from 'capsule-ui/src/utils/aria-utils';
import { t } from 'capsule-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from 'capsule-ui/src/utils/util';
import { isUndefined, isFunction } from 'capsule-ui/src/utils/types';
import { isDef } from 'capsule-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'capsule-ui/src/utils/resize-event';
