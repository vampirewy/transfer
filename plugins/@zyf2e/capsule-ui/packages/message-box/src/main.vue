    ...
    >
      <div class="el-message-box" :class="[customClass, center && 'el-message-box--center']">
        ...
        <div
          ...
          :class="[
            {
              'el-message-box__btns-left': alignFooter === 'left',
              'el-message-box__btns-right': alignFooter === 'right',
              'el-message-box__btns-center': alignFooter === 'center'
            }
          ]"
        >
          <el-button
...
import { addClass, removeClass } from 'capsule-ui/src/utils/dom';
import { t } from 'capsule-ui/src/locale';
import Dialog from 'capsule-ui/src/utils/aria-dialog';
