...
/* harmony default export */ var table_column = ({
  ...
  computed: {
    ...
    realAlign: function realAlign() {
      ...
      return this.columnOrTableParent.align ? 'is-' + this.columnOrTableParent.align : null;
    },
    realHeaderAlign: function realHeaderAlign() {
      if (this.headerAlign) {
        return 'is-' + this.headerAlign;
      }
      return this.columnOrTableParent.headerAlign ? 'is-' + this.columnOrTableParent.headerAlign : this.realAlign;
    }
  },
  ...
  methods: {
    ...
    setColumnRenders: function setColumnRenders(column) {
      ...
      if (column.type === 'expand') {
        ...
        // 对 renderCell 进行包装
        column.renderCell = function (h, data, columnIsHidden) {
          var children = null;
