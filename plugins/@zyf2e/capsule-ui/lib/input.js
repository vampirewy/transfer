...
/* harmony default export */ var inputvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    recoverValue: function recoverValue(value, $input) {
      var _this2 = this;

      var caret = value.length - this.getPosition($input);
      $input.value = this.showValue ? this.showValue : typeof this.value !== 'undefined' ? this.value : null;
      this.$nextTick(function () {
        if ($input.value) {
          var position = $input.value.length - caret;
          position = position > 0 ? position : 0;
          _this2.setCaretPosition($input, position);
        }
      });
    },
