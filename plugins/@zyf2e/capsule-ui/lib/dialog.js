            ...
            "div",
            {
              ...
              class: [
                "el-dialog",
                {
                  ...
                  "el-dialog--mini": _vm.width === "mini",
                  "el-dialog--small": _vm.width === "small",
                  "el-dialog--medium": _vm.width === "medium",
                  "el-dialog--large": _vm.width === "large"
                },
                _vm.customClass
              ],
              style: _vm.style,
              ...
              _vm.$slots.footer
                ? _c(
                    "div",
                    {
                      ...
                      class: [
                        {
                          "el-dialog__footer-left": _vm.alignFooter === "left",
                          "el-dialog__footer-right":
                            _vm.alignFooter === "right",
                          "el-dialog__footer-center":
                            _vm.alignFooter === "center"
                        }
                      ]
                    },
                    [_vm._t("footer")],
  ...
  computed: {
    style: function style() {
      ...
      if (!this.fullscreen) {
        ...
        var inputWidth = widthShortHand[this.width];
