...
module.exports = require("@zyf2e/capsule-ui/lib/utils/date-util");
...
// EXTERNAL MODULE: external "@zyf2e/capsule-ui/lib/utils/date-util"
...
"use strict";
/* harmony import */ var capsule_ui_src_utils_dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var capsule_ui_src_utils_dom__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(capsule_ui_src_utils_dom__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  bind: function bind(el, binding, vnode) {
    ...
    Object(capsule_ui_src_utils_dom__WEBPACK_IMPORTED_MODULE_0__["on"])(el, 'mousedown', function (e) {
      if (e.button !== 0) return;
      startTime = Date.now();
      Object(capsule_ui_src_utils_dom__WEBPACK_IMPORTED_MODULE_0__["once"])(document, 'mouseup', clear);
      clearInterval(interval);
  ...
  methods: {
    ...
    mountPicker: function mountPicker() {
      ...
      var updateOptions = function updateOptions() {
        ...
        var maxDate = _this3.maxDate;
        var minDate = _this3.minDate;
        ...
        _this3.picker.disabledDate = function (time, type) {
          var disable = false;
           ...
           * 修改内容如下
           * 1.添加最大值和最小值prop
           * 2.重写this.picker.disabledDate方法 注入maxDate和minDate逻辑
           * 3.添加 watchMaxDate和unwatchMinDate 监控 可动态修改最大最小值 和 unwatch
           */
          if (maxDate && !disable) {
            if (maxDate === 'today') {
      ...
      this.unwatchMaxDate = this.$watch('maxDate', function () {
        return updateOptions();
      });
      this.unwatchMinDate = this.$watch('minDate', function () {
        return updateOptions();
      });
      if (this.forceUpdate) {
        this.unwatchPickerVisible = this.$watch('pickerVisible', function (val) {
          val && updateOptions();
        });
      }
      ...
      _c(
        ...
        [
          ...
          _c(
            ...
            [
              (!_vm.disabledDate || !_vm.disabledDate(new Date())) &&
              _vm.checkDateWithinRange(new Date())
                ? _c(
                    "el-button",
                    {
                      directives: [
