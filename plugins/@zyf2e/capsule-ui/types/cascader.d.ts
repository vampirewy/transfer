...
import { CascaderOption as CasOption, CascaderProps as CasProps, CascaderNode as CasNode } from './cascader-panel';

export type CascaderOption = CasOption;

export type CascaderProps<V, D> = CasProps<V, D>;

export type CascaderNode<V, D> = CasNode<V, D>;
